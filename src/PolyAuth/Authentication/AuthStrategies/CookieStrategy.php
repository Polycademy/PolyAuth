...
class CookieStrategy extends AbstractStrategy implements StrategyInterface{
	...
	public function __construct(
		...
		$this->cookie_options = array_merge(
			array(
				...
				'autologin_expiration'			=> 86400, // autologin expiration (seconds). Set to zero for no expiration
	...
	public function start_session(){
		...
		//CLEARING COOKIES $this->response->header->clearCookie('autologin')
		//SETTING COOKIES $this->response->header->setCookie(new Cookie('foo', 'bar'));
